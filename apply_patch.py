...
PATCH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'VC2_KoreanPatch_v30.xdelta')
SRC_SHA1 = '809a6a106aaf39d3a5aa18b5d7b0f7b70b6e1d65'
SRC_SIZE = 1120927744
OUT_SHA1 = '59f1ec0a61912223115258a2efb09821f74bc14e'
...
def main():
    ...
    src = sys.argv[1]
    out = sys.argv[2] if len(sys.argv) > 2 else 'VC2_Korean_v30.iso'
    if not os.path.exists(src):
        print(f'[!] Original ISO not found: {src}'); sys.exit(1)
    if not os.path.exists(PATCH):
        print(f'[!] Patch file not found next to this script: {PATCH}')
        print('    Download VC2_KoreanPatch_v30.xdelta from the Releases page and'
