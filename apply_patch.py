...
Put ONE of the patch files next to this script (download from the Releases page):
  - VC2_KoreanPatch_v36_hw.xdelta   real PSP (CFW)  -> Korean-subtitled movies (Sony encoder)
  - VC2_KoreanPatch_v36_emu.xdelta  PPSSPP emulator -> Korean-subtitled movies (x264)
...
The main-ISO patch is byte-identical to v32 (only the DLC changed in v33-v36), so if
...
PATCHES = {
    'VC2_KoreanPatch_v36_hw.xdelta':
        ('a7bb9739c748fc1bd2b8773d8e00332fd4fc98ea', 'VC2_Korean_v36_hw.iso',
         'real PSP (movies Korean-subtitled, Sony PSMF encoder)'),
    'VC2_KoreanPatch_v36_emu.xdelta':
        ('59f1ec0a61912223115258a2efb09821f74bc14e', 'VC2_Korean_v36_emu.iso',
         'PPSSPP (movies Korean-subtitled, x264)'),
    'VC2_KoreanPatch_v35_hw.xdelta':
        ('a7bb9739c748fc1bd2b8773d8e00332fd4fc98ea', 'VC2_Korean_v35_hw.iso',
         'real PSP (movies Korean-subtitled, Sony PSMF encoder)'),
    'VC2_KoreanPatch_v35_emu.xdelta':
        ('59f1ec0a61912223115258a2efb09821f74bc14e', 'VC2_Korean_v35_emu.iso',
         'PPSSPP (movies Korean-subtitled, x264)'),
...
def main():
    ...
    if not found:
        ...
        print('    Download VC2_KoreanPatch_v36_hw.xdelta (real PSP) or '
              'VC2_KoreanPatch_v36_emu.xdelta (PPSSPP)')
