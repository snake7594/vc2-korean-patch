...
Put ONE of the patch files next to this script (download from the Releases page):
  - VC2_KoreanPatch_v35_hw.xdelta   real PSP (CFW)  -> Korean-subtitled movies (Sony encoder)
  - VC2_KoreanPatch_v35_emu.xdelta  PPSSPP emulator -> Korean-subtitled movies (x264)
...
The main-ISO patch is byte-identical to v32 (only the DLC changed in v33-v35), so if
...
def main():
    ...
    if not found:
        ...
        print('    Download VC2_KoreanPatch_v35_hw.xdelta (real PSP) or '
              'VC2_KoreanPatch_v35_emu.xdelta (PPSSPP)')
