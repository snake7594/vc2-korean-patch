...
PATCH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'VC2_KoreanPatch_v27.xdelta')
SRC_SHA1 = '809a6a106aaf39d3a5aa18b5d7b0f7b70b6e1d65'
SRC_SIZE = 1120927744
OUT_SHA1 = '87b644f2facafcce7416dfac97e2a49f69ae24e6'
...
def main():
    ...
    src = sys.argv[1]
    out = sys.argv[2] if len(sys.argv) > 2 else 'VC2_Korean_v27.iso'
